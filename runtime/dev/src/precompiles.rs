...
impl<R> PrecompileSet for TakerPrecompiles<R>
	...
	// <R as pallet_asset_currency::Config>::Call: Dispatchable<PostInfo = PostDispatchInfo> + GetDispatchInfo,
		<R as frame_system::Config>::RuntimeCall: Dispatchable<PostInfo = PostDispatchInfo> + GetDispatchInfo,
	// <<R as pallet_asset_currency::Config>::Call as Dispatchable>::RuntimeOrigin: From<Option<R::AccountId>>,
		<<R as frame_system::Config>::RuntimeCall as Dispatchable>::RuntimeOrigin: From<Option<R::AccountId>>,
	// <R as pallet_asset_currency::Config>::Call: From<pallet_asset_currency::Call<R>>,
