...
use taker_testnet_runtime::{AccountId, Balance, WASM_BINARY, GenesisConfig, SS58Prefix, StakerStatus, ImOnlineId, opaque::SessionKeys, Precompiles};
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: vec![],
			epoch_config: Some(taker_testnet_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
